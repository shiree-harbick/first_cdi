...
write.csv(omnibus, file.path("results/mixed_anova_omnibus.csv"), row.names = FALSE)
...
write.csv(simple_tab, file.path("results/followup_simple_effects.csv"), row.names = FALSE)
write.csv(trend_tab,  file.path("results/followup_dose_trend.csv"),     row.names = FALSE)

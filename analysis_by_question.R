...
StudentClinician2019 <- gsheet2tbl("https://docs.google.com/spreadsheets/d/1LrUA_a0lsCMsuKaktlQRSm_eyUVr6vjP/edit?usp=sharing&ouid=110614759361893702567&rtpof=true&sd=true")
StudentClinician2020 <- gsheet2tbl("https://docs.google.com/spreadsheets/d/1gRuKxApgIrf1Sg4-F84VNmd5Q_jCKtll/edit?usp=sharing&ouid=110614759361893702567&rtpof=true&sd=true")
StudentClinician2021 <- gsheet2tbl("https://docs.google.com/spreadsheets/d/1uyfJdMDTr-2wudYEIkIyWwQN8AIl4CK7/edit?usp=sharing&ouid=110614759361893702567&rtpof=true&sd=true")
StudentClinician2023 <- gsheet2tbl("https://docs.google.com/spreadsheets/d/1B174zwfe-DOK4PuzX83Nsa_VaXA-X_B3/edit?usp=sharing&ouid=110614759361893702567&rtpof=true&sd=true")
...
write.csv(StudentClinicianAll, "~/Downloads/student-clinician-all.csv", row.names=FALSE)
write.csv(StudentClinicianAllCleaned, "/Users/shiree/Desktop/FIRST/Data Analysis/first_studentclinician/student-clinician-all-cleaned_20260424.csv", row.names=FALSE)
